...
from im_car_light import Car_light
car_light = Car_light()
import im_config as cfg
from im_motor import RobotDirection
go = RobotDirection()
from im_socket import Socket
socket = Socket()
from im_infrared import Infrared
infrared = Infrared()
# from xr_ultrasonic import Ultrasonic
# ultrasonic = Ultrasonic()
from im_camera import Camera
camera = Camera()
from im_function import Function
function = Function()
from im_oled import Oled
try:
    oled = Oled()
except:
...
# beep = Beep()
from im_power import Power
power = Power()
from im_servo import Servo
servo = Servo()
from im_ps2 import PS2
ps2 = PS2()
